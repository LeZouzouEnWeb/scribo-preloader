...
if (!function_exists("wptscribo_preloader_head")) {
    function wptscribo_preloader_head()
    { ?>
        <style id="chgt-style">
            #chgt {
                display: block;
...
add_action('wp_head', 'wptscribo_preloader_head');
...
if (!function_exists("wptscribo_preloader_script")) {
    function wptscribo_preloader_script()
    {
?>
        <script id='wptscribo__script'>

        </script>
    <?php
    }
}
add_action('wp_footer', 'wptscribo_preloader_script');